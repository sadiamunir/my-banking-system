...
if (mysqli_num_rows($result) >= 0) {
  ...
  echo "<table ><tr><th>Person ID</th> <th>First Name </th> <th>Last Name </th> <th>Contact </th> <th>Email </th> <th>Amount (Rs.) </th> <th> Transaction </th> </tr>";
  while($row = mysqli_fetch_assoc($result)) {
        
        echo "<tr><td> " . $row["personID"]. "</td> <td>" . $row["first_name"]. "</td> <td>" . $row["last_name"]."</td> <td>" . $row["contact"]. "</td> <td>"  . $row["email"]. "</td> <td>" . $row["amount"]. "</td> <td><a href=\"transaction.php?personID=$row[personID]\">Pay</a> </td>></tr> ";
  }
